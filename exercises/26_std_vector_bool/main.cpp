...
int main(int argc, char **argv) {
    ...
    {
        // std::vector<bool>是一个特殊版本，通常把多个布尔值压缩到同一个字节中，每个元素只占1个bit
        // auto ref = vec[30] 不等价于 bool ref = vec[30]，而是接近 std::vector<bool>::reference ref = vec[30]
        // 代理对象内部记录着 vec[30] 所在的位置
        auto ref = vec[30];
